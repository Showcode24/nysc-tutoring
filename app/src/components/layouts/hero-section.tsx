    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative px-4 md:px-8 py-24 md:py-36">
        ...
        >
          ...
          >
            Kopa360 is a professional tutoring platform that connects verified,
            qualified tutors with students who need them. Join a trusted
            community of educators making a difference.
          </motion.p>
          ...
          >
            Trusted by{" "}
            <span className="font-semibold text-foreground">2,500+</span> tutors
            across Nigeria
          </motion.p>
        </motion.div>
      </div>
